<template>
  <el-form
    ...
    status-icon
  >
    <div class="parent"><el-text class="mx-1" size="large">Online consultation form</el-text></div>
    <el-button class="btn" type="primary" plain
      @click="closeTable"><el-icon><Close /></el-icon
    ></el-button>
    ...
    <el-form-item label="ETA" required>
      <el-col :span="24">
    ...
    <el-form-item label="Query type" prop="type">
      <el-checkbox-group v-model="ruleForm.type">
        ...
        <el-checkbox value="Cuisine" name="type">
          Cuisine
        </el-checkbox>
    ...
    <el-form-item label="Query content" prop="content">
  ...
  const postData = async () => {
    try {
      ...
      const formData = {
        ...
        dateTime: ruleForm.dateTime.toString(),
        type: ruleForm.type,
