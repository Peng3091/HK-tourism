      ...
      <div class="login-box">
        ...
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="密码">
            <el-input type="password" v-model="form.password" placeholder="请输入6-8位密码"></el-input>
          </el-form-item>
          <el-form-item class="submitBtn">
            <el-button type="primary" @click="register">立即注册</el-button>
            <el-button type="default" @click="login">立即登录</el-button>
          </el-form-item>
        </el-form>
        <el-alert
          v-if="showAlert"
...
const register = async () => {
  if (form.value.password.length < 6 || form.value.password.length > 8) {
    alert("请输入6-8位密码");
    return;
  }
